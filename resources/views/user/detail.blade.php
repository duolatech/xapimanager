  ...
  <div class="col bg-white-only">
      <div class="wrapper-sm b-b">
        <div class="m-t-n-xxs m-b-n-xxs m-l-xs">
          <a href="/User/info?uid={{$info['user']['uid'] or ''}}" class="btn btn-xs btn-default ng-hide">编辑</a>
        </div>
      </div>
      <div class="row-row">
        <div class="cell">
              ...
              <div class="hbox h-auto m-b-lg">
                <div class="col text-center w-sm">
                  <div class="thumb-lg avatar inline">
                    <img class="userAvatar" src="{{Session::get('avatar')}}">
                  </div>
                </div>
              </div>
              <!-- fields -->
              <div class="form-horizontal">
                <div class="form-group m-b-sm">
                  ...
                  <div class="col-sm-6 form-control-static">
                    <label>{{$info['user']['username'] or ''}}</label>
                  </div>
                </div>
                <div class="form-group m-b-sm">
                  <label class="col-sm-3 control-label">用户组：</label>
                  <div class="col-sm-6 form-control-static">
                    <label>{{$info['user']['groupname'] or ''}}</label>
                  </div>
                </div>
                <div class="form-group m-b-sm">
                  <label class="col-sm-3 control-label">手机号：</label>
                  <div class="col-sm-6 form-control-static">
                  		<label>{{$info['user']['phone'] or ''}}</label>
                  </div>
                </div>
                <div class="form-group m-b-sm">
                  <label class="col-sm-3 control-label">E-mail：</label>
                  <div class="col-sm-6 form-control-static">
                  	<label>{{$info['user']['email'] or ''}}</label>
                  </div>
                </div>
                <div class="form-group m-b-sm">
                  <label class="col-sm-3 control-label">状态：</label>
                  <div class="col-sm-6 form-control-static">
                  	  <label>{{$info['user']['userStatus'] or ''}}</label> 
                  </div>
                </div>
